...
Este repositório reúne projetos desenvolvidos para praticar e aperfeiçoar aplicações em desenvolvimento Full Stack, incluindo:

 Sistemas de autenticação de usuários
 APIs REST
 Chats em tempo real com Socket.IO
 Integração com bancos de dados
 Aplicações React
 Projetos com Node.js e Express
